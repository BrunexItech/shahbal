...
async def clean():
    async with engine.begin() as conn:
        ...
        for table in ("audit_logs", "call_recordings", "sip_accounts", "agent_presence", "messages", "call_logs", "visit_photos", "visits", "message_campaigns", "election_settings", "plan_weeks", "voters",
